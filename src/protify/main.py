...
def parse_arguments():  
    ...
    parser.add_argument("--embedding_scaler", choices=["standard", "none"], default="standard", help="Feature scaling for pooled vector embeddings during probe/scikit training.")
    ...
    if args.yaml_path is not None:
        ...
        if "embedding_scaler" not in yaml_args.__dict__:
